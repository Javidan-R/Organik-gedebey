...
allOrders: OrderFull[], filteredOrders: OrderFull[], analytics: AnalyticsFn, 
) {
  ...
  const filteredMetrics = useMemo(() => {
    const totalRevenue = filteredOrders.reduce((sum, o) => sum + (typeof o.total === 'number' ? o.total : parseFloat(o.total || '0')), 0);
