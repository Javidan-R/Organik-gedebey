...
export default function CategoryPage() {
  ...
  // Store məlumatları - optimized selectors to prevent re-renders
  ...
  // Filterlərin sayı (aktiv filter sayı) - memoized to prevent re-renders
  const activeFilterCount = useMemo(() => [
    showOnlyInStock, onlyDiscounted, onlyNew, minRating > 0, searchTerm !== '', minPrice > 0 || maxPrice < 500
  ].filter(Boolean).length, [showOnlyInStock, onlyDiscounted, onlyNew, minRating, searchTerm, minPrice, maxPrice])
