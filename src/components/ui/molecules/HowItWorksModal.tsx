// components/ui/molecules/HowItWorksModal.tsx
"use client";
        ...
        >
          ...
          >
            ...
            <div className="relative bg-gradient-to-r from-emerald-600 to-green-700 p-6 text-white flex-shrink-0">
              ...
              {/* Addım göstəricisi yalnız təlimat modunda */}
              {!isCheckout && (
            ...
            <div className="p-6 overflow-y-auto flex-1">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {/* Checkout formu (həm təlimat son addım, həm birbaşa) */}
                  {(isCheckout || step === 3) && (
                  ...
                  {/* Təlimat modunda son addımda təsdiq mesajı */}
                  {!isCheckout && step === 3 && (
            ...
            <div className="p-6 border-t bg-gray-50 flex-shrink-0">
              <div className="flex gap-3">
                {/* Geri yalnız təlimat modunda və ilk addım deyilsə */}
                {!isCheckout && step > 0 && (
                  <button
