...
export default function StoreFooter() {
  ...
  return (
    <>
      <footer
        ref={footerRef}
        className="relative mt-16 overflow-hidden bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white"
        style={primaryStyle}
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-emerald-400/3 blur-3xl" />
        </div>
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 pb-10 border-b border-white/5">
              ...
              >
                <Link href="/" className="group inline-flex items-center gap-3">
                  <div className="relative">
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-110 transition-transform duration-300">
                      <Leaf className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute -inset-1 rounded-xl bg-emerald-500/20 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  </div>
                  <span
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-white/[0.04] border border-white/5 p-6 backdrop-blur-sm">
                ...
                <div className="relative z-10">
                  ...
                  <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="group flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-white transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 py-10 border-b border-white/5">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                {categories.length > 5 && (
                  <li className="text-sm text-gray-500">+ {categories.length - 5} daha</li>
                )}
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8 border-b border-white/5">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-center gap-4 p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-all duration-300"
              >
        ...
        <AnimatePresence>
          {showBackToTop && (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={scrollToTop}
              className="fixed bottom-24 right-6 z-50 p-3 rounded-full shadow-2xl transition-all duration-300"
              style={{ backgroundColor: config.primaryColor }}
            >
      ...
      {/* Global Styles – smooth scrolling and selection */}
      <style jsx global>{`
        html {
